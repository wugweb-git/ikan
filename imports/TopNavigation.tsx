import svgPaths from "./svg-53vrzosjep";
...
function Container2() {
  return (
    <div className="basis-0 content-stretch flex grow h-[88px] items-center justify-between min-h-px min-w-px relative shrink-0" data-name="Container">
      <Container />
      <Container1 />
    </div>
  );
