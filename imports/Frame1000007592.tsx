import svgPaths from "./svg-innq7omzrb";
...
function Frame1000007580() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-start left-1/2 p-[100px] top-0 translate-x-[-50%] w-[1440px]">
      <Frame41 />
      <Frame1000007579 />
    </div>
  );
...
function Frame1000007585() {
  return (
    <div className="absolute bg-[#f7f7f7] box-border content-stretch flex flex-col gap-[32px] items-start left-1/2 p-[100px] top-[850px] translate-x-[-50%] w-[1440px]">
      <Frame40 />
      <Frame1000007584 />
    </div>
  );
...
function Frame1000007587() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[10px] items-start justify-center left-1/2 p-[100px] top-[1441px] translate-x-[-50%] w-[1440px]">
      <Frame1000007589 />
    </div>
  );
}

export default function Frame1000007592() {
  return (
